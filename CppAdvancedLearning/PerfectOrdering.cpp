...
//std::mutex mtx2;
//
//// this is an example of perfect ordering a solution for deadlock 
...
//void func2()
//{
//    std::cout << "Thread 2 has tried to lock the mutex1" << std::endl;
//    std::lock_guard lck(mtx1);
//    std::cout << "Thread 2 has locked mutex 1" << std::endl;
//
//    std::this_thread::sleep_for(50ms);
//    std::cout << "Thread 2 has tried to lock the mutex 2" << std::endl;
//    std::lock_guard lck2(mtx2);
